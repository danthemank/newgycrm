<?php
/**
 * Administration API: plugin_list_table class
 *
 * @package WordPress
...
class plugin_list_table {
	...
	public function ajax_user_can() {
		die( 'function plugin_list_table::ajax_user_can() must be overridden in a subclass.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 *
	 * @uses plugin_list_table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @abstract
	 */
	public function prepare_items() {
		die( 'function plugin_list_table::prepare_items() must be overridden in a subclass.' );
	}
...
<p class="search-box">
	...
	public function get_columns() {
		die( 'function plugin_list_table::get_columns() must be overridden in a subclass.' );
	}
	...
	/**
	 * Public wrapper for plugin_list_table::get_default_primary_column_name().
	 *
	 * @since 4.4.0
	 *
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	/**
	 * Gets a list of CSS classes for the plugin_list_table table tag.
	 *
	 * @since 3.1.0
	 *
